...
public class GaoXiaoVideoFragment extends Fragment {

    // 搞笑视频新闻的 url
    private String url = "http://c.3g.163.com/nc/video/list/V9LG4E6VR/n/0-10.html";

    private MediaPlayer mPlayer;
    private int pos;

    public static GaoXiaoVideoFragment newInstance() {
        GaoXiaoVideoFragment fragment = new GaoXiaoVideoFragment();
        return fragment;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        uov.getAsyncDataList(url, adapter, 1);
        listView.setEmptyView(progressBar);
        uov.clickVideoForXListView(url, adapter, 1, listView, mPlayer);
    }
