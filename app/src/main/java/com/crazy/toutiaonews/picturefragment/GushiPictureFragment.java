...
public class GushiPictureFragment extends Fragment {

    // 图片新闻的 url
    private String url = "http://api.sina.cn/sinago/list.json?channel=hdpic_story&adid=4ad30dabe134695c3b7c3a65977d7e72&wm=b207&from=6042095012&chwm=12050_0001&oldchwm=12050_0001&imei=867064013906290&uid=802909da86d9f5fc&p=";

    public static GushiPictureFragment newInstance() {
        GushiPictureFragment fragment = new GushiPictureFragment();
