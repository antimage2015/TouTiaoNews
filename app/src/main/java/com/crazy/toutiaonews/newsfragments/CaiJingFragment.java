...
public class CaiJingFragment extends Fragment {
    ...
    private String url = "http://c.m.163.com/nc/article/list/T1348648756099/0-20.html";
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        utils.getAsyncDataList(url, adapter, listView, 3);
        utils.clickForXListView(url, adapter, listView, 3);
    }
